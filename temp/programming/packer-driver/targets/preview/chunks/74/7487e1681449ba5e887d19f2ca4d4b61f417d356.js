      ...
      _export("GameManager", GameManager = class GameManager {
        ...
        initializeSystems() {
          this.renderSystem = new (_crd && RenderSystem === void 0 ? (_reportPossibleCrUseOfRenderSystem({
            error: Error()
          }), RenderSystem) : RenderSystem)(this.entityManager, this.prefabs, this.gameRoot, this.tilesLayer, this.entityLayer, this.tileSize);
        ...
        setGameRoot(gameRoot, tilesLayer, entityLayer) {
...
//# sourceMappingURL=7487e1681449ba5e887d19f2ca4d4b61f417d356.js.map