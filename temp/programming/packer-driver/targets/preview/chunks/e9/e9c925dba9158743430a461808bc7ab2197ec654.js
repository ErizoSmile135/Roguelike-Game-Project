System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Prefab, Node, gameManager, initializeGame, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _class3, _crd, ccclass, property, SceneController;
    ...
    execute: function () {
      ...
      _export("SceneController", SceneController = (_dec = ccclass('SceneController'), _dec2 = property({
        ...
        constructor() {
          ...
          _initializerDefineProperty(this, "playerLayer", _descriptor7, this);
        }
        ...
        start() {
          ...
          (_crd && initializeGame === void 0 ? (_reportPossibleCrUseOfinitializeGame({
            ...
            (_crd && gameManager === void 0 ? (_reportPossibleCrUseOfgameManager({
              error: Error()
            }), gameManager) : gameManager).setGameRoot(this.gameRoot, this.tilesLayer, this.entityLayer, this.playerLayer);
            (_crd && gameManager === void 0 ? (_reportPossibleCrUseOfgameManager({
              error: Error()
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "playerLayer", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=e9c925dba9158743430a461808bc7ab2197ec654.js.map