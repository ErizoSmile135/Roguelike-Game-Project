System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, instantiate, Vec3, UITransform, PlayerTag, PrefabNames, EnemyTag, TileTag, Position, ViewComponent, RenderSystem, _crd;
      ...
      _export("RenderSystem", RenderSystem = class RenderSystem {
        ...
        render() {
          ...
          for (var id of entities) {
            var prefabName = this.getPrefabName(id);
            if (!prefabName) continue;
            var position = this.entityManager.getComponent(id, _crd && Position === void 0 ? (_reportPossibleCrUseOfPosition({
              error: Error()
            }), Position) : Position);
            ...
            if (!view) {
              //if (prefabName == PrefabNames.Tile) continue;
              ...
              var prefab = this.prefabs[prefabName];
...
//# sourceMappingURL=d441c7c8fe71734623c05ab4dad2557b5bae3fdf.js.map