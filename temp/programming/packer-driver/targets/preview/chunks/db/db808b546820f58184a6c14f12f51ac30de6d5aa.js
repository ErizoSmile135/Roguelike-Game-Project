        ...
        render() {
          ...
          for (var id of entities) {
            ...
            if (!view) {
              ...
              var z = 0;
              if (prefabName === 'Tile') z = 0;else if (prefabName === 'Enemy') z = 1;else if (prefabName === 'Player') z = 2;
              var prefab = this.prefabs[prefabName];
              var node = instantiate(prefab);
              node.setPosition(new Vec3(position.x * 64, position.y * 64, z));
...
//# sourceMappingURL=db808b546820f58184a6c14f12f51ac30de6d5aa.js.map