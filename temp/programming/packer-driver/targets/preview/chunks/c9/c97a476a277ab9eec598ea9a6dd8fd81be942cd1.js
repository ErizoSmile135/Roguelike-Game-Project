  ...
  return {
    ...
    execute: function () {
      ...
      _export("TrapSystem", TrapSystem = class TrapSystem {
        ...
        onTrapTriggered(_ref) {
          var {
            entity,
            trap
          } = _ref;
          var dmgComp = this.em.getComponent(trap, _crd && Damage === void 0 ? (_reportPossibleCrUseOfDamage({
            error: Error()
          }), Damage) : Damage);
          var damage = dmgComp ? dmgComp.damage : 1; // default 1
...
//# sourceMappingURL=c97a476a277ab9eec598ea9a6dd8fd81be942cd1.js.map