            ...
            for (var j = 0; j < width; j++) {
              ...
              if (this.roomTemplate[0].layout[i][j] == 'P') {
                if (!this.entityManager.getEntityWithComponent(_crd && PlayerTag === void 0 ? (_reportPossibleCrUseOfPlayerTag({
                  ...
                  console.log(this.entityManager.getEntityWithComponent(_crd && PlayerTag === void 0 ? (_reportPossibleCrUseOfPlayerTag({
                    error: Error()
                  }), PlayerTag) : PlayerTag));
                  var playerId = this.entityManager.createEntity();
                  ...
                  var _playerId = this.entityManager.getEntityWithComponent(_crd && PlayerTag === void 0 ? (_reportPossibleCrUseOfPlayerTag({
                    error: Error()
                  }), PlayerTag) : PlayerTag)[0];
                  var playerPosition = this.entityManager.getComponent(_playerId, _crd && Position === void 0 ? (_reportPossibleCrUseOfPosition({
                    error: Error()
                  }), Position) : Position);
...
//# sourceMappingURL=cabccde3fa84d08886fd73867f7c928324908def.js.map