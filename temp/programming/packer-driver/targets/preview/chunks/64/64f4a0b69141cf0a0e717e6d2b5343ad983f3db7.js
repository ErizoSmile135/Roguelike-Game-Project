            ...
            for (var j = 0; j < width; j++) {
              ...
              if (this.roomTemplate[0].layout[i][j] == 'T') {
                ...
                this.em.addComponent(trapId, new (_crd && Position === void 0 ? (_reportPossibleCrUseOfPosition({
                  error: Error()
                }), Position) : Position)(i, j), _crd && Position === void 0 ? (_reportPossibleCrUseOfPosition({
                  error: Error()
                }), Position) : Position);
                this.em.addComponent(trapId, new (_crd && Trap === void 0 ? (_reportPossibleCrUseOfTrap({
                  error: Error()
                }), Trap) : Trap)(new (_crd && Damage === void 0 ? (_reportPossibleCrUseOfDamage({
                  error: Error()
                }), Damage) : Damage)(2)), _crd && Trap === void 0 ? (_reportPossibleCrUseOfTrap({
                  error: Error()
                }), Trap) : Trap);
              }
...
//# sourceMappingURL=64f4a0b69141cf0a0e717e6d2b5343ad983f3db7.js.map