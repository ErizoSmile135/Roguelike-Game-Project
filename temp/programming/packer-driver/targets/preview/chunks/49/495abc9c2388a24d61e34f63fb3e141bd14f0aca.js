      ...
      _export("RenderSystem", RenderSystem = class RenderSystem {
        constructor(entityManager, prefabs, gameRoot, tilesLayer, entityLayer, playerLayer, tileSize) {
          ...
          (_crd && eventBus === void 0 ? (_reportPossibleCrUseOfeventBus({
            error: Error()
          }), eventBus) : eventBus).on("positionChanged", _ref => {
            var {
              entity,
              newPos
            } = _ref;
            var view = this.entityManager.getComponent(entity, _crd && ViewComponent === void 0 ? (_reportPossibleCrUseOfViewComponent({
              error: Error()
...
//# sourceMappingURL=495abc9c2388a24d61e34f63fb3e141bd14f0aca.js.map