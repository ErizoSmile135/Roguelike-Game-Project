System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, EntityManager, RenderSystem, RoomSystem, InputSystem, PlayerTag, Health, Damage, InputComponent, Position, GameManager, _crd;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameManager", GameManager = class GameManager {
        ...
        handleInput(input) {
          var inputId = this.entityManager.createEntity();
          this.entityManager.addComponent(inputId, input, _crd && InputComponent === void 0 ? (_reportPossibleCrUseOfInputComponent({
            error: Error()
          }), InputComponent) : InputComponent); //this.inputSystem.handleInput(input);
        }

        onTileTapped(position) {
          var input = new (_crd && InputComponent === void 0 ? (_reportPossibleCrUseOfInputComponent({
            error: Error()
          }), InputComponent) : InputComponent)(this.playerId, 'move', position);
          this.entityManager.addComponent(this.playerId, input, _crd && InputComponent === void 0 ? (_reportPossibleCrUseOfInputComponent({
            error: Error()
...
//# sourceMappingURL=ee4887b5aab80ebe3a677ff09cc64b48183efb2b.js.map