System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, Damage, EnemyTag, Health, Position, TileTag, Trap, RoomSystem, _crd;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("RoomSystem", RoomSystem = class RoomSystem {
        constructor(em, roomTemplate, playerId) {
          this.em = em;
          ...
          for (var i = 0; i < height; i++) {
            for (var j = 0; j < width; j++) {
              if (this.isPassable(this.roomTemplate[0].layout[i][j])) {
                var entityId = this.em.createEntity();
                this.em.addComponent(entityId, new (_crd && TileTag === void 0 ? (_reportPossibleCrUseOfTileTag({
                  error: Error()
                }), TileTag) : TileTag)(), _crd && TileTag === void 0 ? (_reportPossibleCrUseOfTileTag({
                  error: Error()
                }), TileTag) : TileTag);
                this.em.addComponent(entityId, new (_crd && Position === void 0 ? (_reportPossibleCrUseOfPosition({
                  error: Error()
              ...
              if (this.roomTemplate[0].layout[i][j] == 'T') {
                var trapId = this.em.createEntity();
                this.em.addComponent(trapId, new (_crd && Position === void 0 ? (_reportPossibleCrUseOfPosition({
                  error: Error()
                }), Position) : Position)(j, i), _crd && Position === void 0 ? (_reportPossibleCrUseOfPosition({
                  error: Error()
                }), Position) : Position);
                this.em.addComponent(trapId, new (_crd && Trap === void 0 ? (_reportPossibleCrUseOfTrap({
                  error: Error()
                }), Trap) : Trap)(), _crd && Trap === void 0 ? (_reportPossibleCrUseOfTrap({
                  error: Error()
                }), Trap) : Trap);
                this.em.addComponent(trapId, new (_crd && Damage === void 0 ? (_reportPossibleCrUseOfDamage({
                  error: Error()
                }), Damage) : Damage)(2), _crd && Damage === void 0 ? (_reportPossibleCrUseOfDamage({
                  error: Error()
                }), Damage) : Damage);
              }

              if (this.roomTemplate[0].layout[i][j] == 'E') {
                var enemyId = this.em.createEntity();
                this.em.addComponent(enemyId, new (_crd && EnemyTag === void 0 ? (_reportPossibleCrUseOfEnemyTag({
                  error: Error()
                }), EnemyTag) : EnemyTag)(), _crd && EnemyTag === void 0 ? (_reportPossibleCrUseOfEnemyTag({
                  error: Error()
                }), EnemyTag) : EnemyTag);
                this.em.addComponent(enemyId, new (_crd && Health === void 0 ? (_reportPossibleCrUseOfHealth({
                  error: Error()
                }), Health) : Health)(100), _crd && Health === void 0 ? (_reportPossibleCrUseOfHealth({
                  error: Error()
                }), Health) : Health);
                this.em.addComponent(enemyId, new (_crd && Damage === void 0 ? (_reportPossibleCrUseOfDamage({
                  error: Error()
                }), Damage) : Damage)(5), _crd && Damage === void 0 ? (_reportPossibleCrUseOfDamage({
                  error: Error()
                }), Damage) : Damage);
                this.em.addComponent(enemyId, new (_crd && Position === void 0 ? (_reportPossibleCrUseOfPosition({
                  error: Error()
                }), Position) : Position)(j, i), _crd && Position === void 0 ? (_reportPossibleCrUseOfPosition({
                  error: Error()
                }), Position) : Position);
              ...
              if (this.roomTemplate[0].layout[i][j] == 'P') {
                var playerPosition = this.em.getComponent(this.playerId, _crd && Position === void 0 ? (_reportPossibleCrUseOfPosition({
                  error: Error()
                }), Position) : Position);
...
//# sourceMappingURL=b60d29f47151e1ed1b0ed332b22a5775b15ff926.js.map