  ...
  return {
    ...
    execute: function () {
      ...
      _export("InputSystem", InputSystem = class InputSystem {
        ...
        update(dt) {
          for (var eid of this.entityManager.getEntityWithComponent(_crd && InputComponent === void 0 ? (_reportPossibleCrUseOfInputComponent({
            error: Error()
...
//# sourceMappingURL=7bdec68aab398e42ff403a946ead2659f78d1c50.js.map