    ...
    execute: function () {
      ...
      _export("RenderSystem", RenderSystem = class RenderSystem {
        ...
        onMovePath({
          ...
          if (!(view != null && view.node)) return;
          const node = view.node;
          const z = node.getPosition().z; // рекурсивная функция для по-шаговой анимации
          ...
          const animateStep = idx => {
            ...
            tween(node).to(this.stepDuration, {
              ...
              pos.x = step.x;
              pos.y = step.y; // 2) Проверяем ловушки на этой клетке

              const trapIds = this.em.getEntityWithComponent(_crd && Trap === void 0 ? (_reportPossibleCrUseOfTrap({
                error: Error()
...
//# sourceMappingURL=80abd5345fbde7632051487c289f192693d87219.js.map