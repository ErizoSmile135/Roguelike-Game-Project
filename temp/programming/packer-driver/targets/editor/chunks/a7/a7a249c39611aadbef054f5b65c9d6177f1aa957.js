          ...
          for (let i = 0; i < height; i++) {
            for (let j = 0; j < width; j++) {
              ...
              if (this.roomTemplate[0].layout[i][j] == 'P') {
                const playerPosition = this.em.getComponent(this.playerId, _crd && Position === void 0 ? (_reportPossibleCrUseOfPosition({
                  error: Error()
                }), Position) : Position);
...
//# sourceMappingURL=a7a249c39611aadbef054f5b65c9d6177f1aa957.js.map