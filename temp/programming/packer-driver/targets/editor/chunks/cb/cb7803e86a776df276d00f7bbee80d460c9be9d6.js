System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, instantiate, Vec3, Node, PlayerTag, PrefabNames, EnemyTag, TileTag, Position, ViewComponent, SceneController, RenderSystem, _crd;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("RenderSystem", RenderSystem = class RenderSystem {
        constructor(entityManager, prefabs, gameRoot, tilesLayer, entityLayer, tileSize) {
        ...
        render() {
          ...
          for (const id of entities) {
            ...
            if (!view) {
              ...
              if (prefabName === (_crd && PrefabNames === void 0 ? (_reportPossibleCrUseOfPrefabNames({
                error: Error()
              }), PrefabNames) : PrefabNames).Player) //node.setSiblingIndex(this.gameRoot.children.length - 1);
                this.gameRoot.addChild(node);else if (prefabName === (_crd && PrefabNames === void 0 ? (_reportPossibleCrUseOfPrefabNames({
                error: Error()
...
//# sourceMappingURL=cb7803e86a776df276d00f7bbee80d460c9be9d6.js.map