System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, eventBus, Position, Trap, _dec, _class, _crd, ccclass, TrapSystem;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("TrapSystem", TrapSystem = (_dec = ccclass('TrapSystem'), _dec(_class = class TrapSystem {
        constructor(em) {
          this.em = em;
        ...
        onMoveComplete(payload) {
          const actor = payload.entity; // получаем позицию, куда встал актор
          ...
          const traps = this.em.getEntityWithComponent(_crd && Trap === void 0 ? (_reportPossibleCrUseOfTrap({
            error: Error()
          }), Trap) : Trap).filter(trapId => {
            const trapPos = this.em.getComponent(trapId, _crd && Position === void 0 ? (_reportPossibleCrUseOfPosition({
              error: Error()
            }), Position) : Position);
          ...
          for (const trapId of traps) {
            const trap = this.em.getComponent(trapId, _crd && Trap === void 0 ? (_reportPossibleCrUseOfTrap({
              error: Error()
            }), Trap) : Trap);
...
//# sourceMappingURL=beec18712b5cb19b409cf13da23ece0a27c17400.js.map