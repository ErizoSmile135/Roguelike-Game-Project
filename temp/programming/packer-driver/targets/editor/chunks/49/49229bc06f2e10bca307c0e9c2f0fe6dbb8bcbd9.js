System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, instantiate, Vec3, Node, PlayerTag, PrefabNames, EnemyTag, TileTag, Position, ViewComponent, SceneController, eventBus, RenderSystem, _crd;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("RenderSystem", RenderSystem = class RenderSystem {
        constructor(entityManager, prefabs, gameRoot, tilesLayer, entityLayer, playerLayer, tileSize) {
          ...
          (_crd && eventBus === void 0 ? (_reportPossibleCrUseOfeventBus({
            error: Error()
          }), eventBus) : eventBus).on("positionChanged", ({
            entity,
            newPos
          }) => {
            const view = this.entityManager.getComponent(entity, _crd && ViewComponent === void 0 ? (_reportPossibleCrUseOfViewComponent({
              error: Error()
            }), ViewComponent) : ViewComponent);

            if (view != null && view.node) {
              view.node.setPosition(new Vec3(newPos.x * this.tileSize, newPos.y * this.tileSize, 0));
            }
          });
        }
        ...
        update(dt) {
          const entities = this.entityManager.getEntityWithComponent(_crd && ViewComponent === void 0 ? (_reportPossibleCrUseOfViewComponent({
            error: Error()
          }), ViewComponent) : ViewComponent);

          for (const id of entities) {
            const view = this.entityManager.getComponent(id, _crd && ViewComponent === void 0 ? (_reportPossibleCrUseOfViewComponent({
              error: Error()
            }), ViewComponent) : ViewComponent);
            const pos = this.entityManager.getComponent(id, _crd && Position === void 0 ? (_reportPossibleCrUseOfPosition({
              error: Error()
            }), Position) : Position);
...
//# sourceMappingURL=49229bc06f2e10bca307c0e9c2f0fe6dbb8bcbd9.js.map