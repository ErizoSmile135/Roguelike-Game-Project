        ...
        createRoom() {
          ...
          for (let i = 0; i < height; i++) {
            for (let j = 0; j < width; j++) {
              if (this.roomTemplate[0].layout[i][j] == '.') {
              ...
              if (this.roomTemplate[0].layout[i][j] == 'P') {
                const playerPosition = this.entityManager.getComponent(this.playerId, _crd && Position === void 0 ? (_reportPossibleCrUseOfPosition({
                  error: Error()
                }), Position) : Position);
...
//# sourceMappingURL=13faa83687d9d61f8eb3ac62f12db711a81a4369.js.map