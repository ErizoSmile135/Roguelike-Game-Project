      ...
      _export("MovementSystem", MovementSystem = class MovementSystem {
        ...
        update(dt) {
          ...
          for (const actorId of movers) {
            const mi = this.em.getComponent(actorId, _crd && MoveIntent === void 0 ? (_reportPossibleCrUseOfMoveIntent({
              error: Error()
            }), MoveIntent) : MoveIntent);
            const {
              x,
            ...
            const pos = this.em.getComponent(actorId, _crd && Position === void 0 ? (_reportPossibleCrUseOfPosition({
              error: Error()
            }), Position) : Position);
            pos.x = x;
            pos.y = y;
...
//# sourceMappingURL=158d6b9d698ec1a0bb5a88f100a0b5651a4dd16b.js.map